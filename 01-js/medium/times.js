...
function calculateSumTime(n) {
    const startTime = new Date().getTime(); // Get current time in milliseconds before calculation
    ...
    const endTime = new Date().getTime(); // Get current time in milliseconds after calculation
